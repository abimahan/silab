...
@section('content-header-right')
  {!! $create_mahasiswa !!} {!! $create_button !!}
@endsection
...
@section('content')
  ...
  <!-- Add User Modals Mahasiswa -->
  <div class="modal fade" id="addMahasiswa" aria-hidden="false" aria-labelledby="adduserModalLabel" role="dialog" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Tambah deneng {{ $title }}</h4>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
        <div class="modal-body">
          <form class="form-horizontal form-element" action="{{ $create_route }}" method="POST">
