...
class PraktikumController extends Controller
{
	...
	protected $title_mahasiswa = "Mahasiswa Aktif";
	...
	public function index()
	{
		...
		if(Content::menuPermission('create')){
			...
			$data['create_mahasiswa'] = '<button class="btn btn-sm btn-default" data-target="#addMahasiswa" data-toggle="modal">
											<i class="fa fa-plus" aria-hidden="true"></i>
											<span class="hidden-xs">Tambah '.$this->title_mahasiswa.'</span>
										</button>';
		}
